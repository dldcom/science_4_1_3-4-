...
1. `마그마 식히기`를 누르면 마그마가 천천히 식기 시작합니다.
...
`현무암·화강암 비교`를 누르면 실제 런타임 텍스처를 확대해 두 암석을 나란히 관찰할 수 있습니다.

- 현무암: 지표 가까이에서 빠르게 식어 광물 알갱이가 매우 작습니다.
- 화강암: 지하 깊은 곳에서 천천히 식어 석영·장석·흑운모 알갱이가 눈에 보입니다.

비교 화면의 `확인 퀴즈 시작`을 누르면 생성 위치, 냉각 속도, 광물 알갱이 특징을 묻는 3문항을 풀 수 있습니다. 답을 선택하면 정답과 이유를 바로 확인할 수 있습니다.
